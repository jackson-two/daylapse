/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 111b6f0aa61ebb4a9f1a17ad804f9307)
// Runtime types generated with workerd@1.20260921.1 2026-08-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	DAYLAPSE: {"familyHostname":"localhost","displayHostname":"","accessTeamDomain":"","accessAudience":"","timeZone":"UTC","notifications":false,"localDevelopment":true};
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DAYLAPSE">> {}
}
